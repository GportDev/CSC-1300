...
void getAnimals(string *animalsArray) {
	string *animalsPtr;
	animalsPtr = animalsArray;

	cout << "\n\nPlease enter your favorite animals:\n";

	for(int i = 0; i < SIZE; i++) {
		cout << "ANIMAL " << i+1 << ": ";
		getline(cin, *(animalsPtr + i));
	}
